  ...
  [
    {
      ...
      texto: (
        <>
          ...
          <SlideText>
            O cadastro pode ser feito pelo celular se você possuir o aplicativo
            da Receita.
          </SlideText>
        </>
      ),
    ...
    },
    {
      ...
      texto: (
        <>
          ...
          <SlideText>
            Após esse prazo, caso queira continuar doando você precisará refazer
            esse passo-a-passo.
          </SlideText>
        </>
      ),
    ...
    },
    {
      ...
      texto: (
        <>
          <SlideText>
            Pronto! Agora quando fizer suas compras, não se esqueça de pedir o
            CPF e seus créditos irão para a AGENTE de forma automática!
          </SlideText>
        </>
      ),
    },
      ...
      texto: (
        <>
          <SlideText>
            ...
            facul, tios, vizinhos e vamos juntos ser agentes de transformação!
          </SlideText>
        </>
      ),
    },
...
const projetos = [
  ...
  },
  {
    ...
    descricao:
      "Acompanhamento físico e nutricional (parceria com Pastoral da Criança)",
    link: "",
  },
  {
    nome: "Agente Joga",
...
const useStyles = makeStyles((theme) => {
  ...
  return {
    ...
    fundoVermelho: {
      ...
      backgroundImage: 'url("/images/comunidade.png")',
    },
    introImgBoxBorder: {
      width: "100vw",
      height: "60vh",
      ...
      [theme.breakpoints.up("md")]: {
        ...
        clipPath: "polygon(0% 0%, 75% 0, 100% 33%, 80% 100%, 0% 100%)",
        width: "inherit",
        height: "inherit",
        flexGrow: 1,
    ...
    introImgBox: {
      ...
      [theme.breakpoints.up("md")]: {
        display: "flex",
        paddingTop: 0,
        clipPath: "polygon(0% 0%, 74% 0, 100% 34%, 80% 100%, 0% 100%)",
        width: "100%",
        height: "100%",
...
const IndexPage = () => {
      ...
      <Box className={classes.tutorialContainer}>
        ...
        <Box className={classes.tituloTutorialContainer}>
          <Typography className={classes.tituloTutorial}>
            <span className={classes.tituloTutorialNumero}>
              {currentSlideIdx + 1}
            </span>
            <span className={classes.tituloTutorialTexto}>
              {currentSlide.titulo}
            </span>
          </Typography>
          <img
            src={currentSlide.icone}
            className={classes.tituloTutorialIcone}
            alt=""
          />
        </Box>
        <Box>
          <Box className={classes.slideImgContainer}>
            ...
            <Button
              className={classes.slideImgButton}
              onClick={handleShowFullImg}
            >
              <img
                className={classes.slideImg}
                src={currentSlideDeck[currentSlideIdx].passo}
                alt={currentSlideDeck[currentSlideIdx].titulo}
              />
            </Button>
            <Button
              className={classes.slideButton}
          ...
          <Box className={classes.slideTextContainer}>{currentSlide.texto}</Box>
        </Box>
      </Box>
    </>
  );
      ...
      <Grid container spacing={2}>
        <Grid item xs={3}>
          <Grid
            ...
            direction="column"
            spacing={2}
            className={classes.tabDesktopContainer}
          >
          ...
          <Box className={classes.slideDesktopContainer}>
            ...
            <Box className={classes.slideDesktopImgContainer}>
              <Box className={classes.slideImgContainer}>
                ...
                <Button
                  onClick={handleShowFullImg}
                  className={classes.slideImgButtonDesktop}
                >
  ...
  const video = (
    <Box className={classes.videoContainer}>
      ...
      >
        <iframe
          title="Doação da Nota Fiscal Paulista"
          style={{
            position: "absolute",
            top: 0,
            left: 0,
    ...
    <main>
      <ThemeProvider theme={theme}>
        ...
        <Head>
          ...
          <link
            href="https://fonts.googleapis.com/css2?family=Barlow+Condensed:wght@400;700&family=Cuprum:wght@700&family=Montserrat:wght@100;400;700;800&display=swap"
            rel="stylesheet"
          />
        </Head>
        <AppBar
        ...
        >
          ...
          <div className={classes.sectionDesktop}>
            <Scrollspy
              items={[intro, comoDoar, sobre, faq]}
              currentClassName="is-current"
              offset={-theme.spacing(7) * 2}
            >
              <Button component="a" className={classes.hide}>
                <Typography className={classes.tituloMenu}>
                  Introdução
                </Typography>
              </Button>
        ...
        <section
          id={intro}
          className={clsx(classes.responsiveContainer, classes.fundoVermelho)}
        >
          <Box className={classes.introImgBoxBorder}>
            <Box className={classes.introImgBox}></Box>
          </Box>
          <Box className={classes.introTextBox}>
            <div>
              <Typography className={classes.introTitle}>
                Transforme seus gastos em impacto social
              </Typography>
              <div className={classes.introBodyVideo}>
                <div className={classes.introBodyContainer}>
        ...
        <section id={sobre}>
          <Box className={classes.conteudo}>
            ...
            <Box className={classes.responsiveContainer}>
              <img
                src="/images/foto-agente.png"
                alt="Foto da fachada da Agente"
              ...
              <Box className={classes.quemSomosContainer}>
                <Typography>
                  ...
                  onde moram cerca de 8 mil pessoas e fica ao lado da USP.
                </Typography>
                <Typography>
                  Desenvolvemos{" "}
                  <span className={classes.highlight}>
              ...
              {projetos.map((projeto, index) => (
                <div key={projeto.nome} className={classes.slide}>
                  <Box className={classes.projetoContainer}>
                    <a className={classes.logoProjeto} href={projeto.link}>
                      <img
                        className={classes.slideImg}
                        src={projeto.logo}
                        alt={projeto.nome}
                    ...
                    <Typography className={classes.descricaoProjeto}>
                      {projeto.descricao}
                    </Typography>
                  </Box>
                </div>
        ...
        <section id={faq}>
          <Box
            className={clsx(classes.conteudo, classes.faq, classes.textoPreto)}
          >
            <Typography
              className={clsx(
                classes.titulo,
            ...
            <Accordion className={classes.faqEntry}>
              ...
              >
                <Typography className={classes.pergunta}>
                  1. O que é o programa da Nota Fiscal Paulista?
                </Typography>
              </AccordionSummary>
              <AccordionDetails className={classes.accordionDetails}>
                <Typography className={classes.resposta}>
                  R: É um programa de estimulo à cidadania fiscal no Estado de
                  São Paulo, que tem por objetivo estimular os consumidores a
                  exigirem a entrega do documento fiscal na hora da compra. Além
                  disso, visa gerar créditos aos consumidores, aos cidadãos e às
                  empresas do Estado.
                </Typography>
              </AccordionDetails>
            </Accordion>
            ...
            <Accordion className={classes.faqEntry}>
              ...
              >
                <Typography className={classes.pergunta}>
                  2. Fiz a doação automática, mas quero parar. Posso cancelar?
                </Typography>
              </AccordionSummary>
              <AccordionDetails className={classes.accordionDetails}>
                <Typography className={classes.resposta}>
            ...
            <Accordion className={classes.faqEntry}>
              ...
              >
                <Typography className={classes.pergunta}>
                  3. Não tenho conta. Como posso criar uma?
                </Typography>
              </AccordionSummary>
              <AccordionDetails className={classes.accordionDetails}>
                <Typography className={classes.resposta}>
                  R: Acesse o site da{" "}
                  <Link href="https://www.nfp.fazenda.sp.gov.br/login.aspx">
            ...
            <Accordion className={classes.faqEntry}>
              ...
              >
                <Typography className={classes.pergunta}>
                  4. Criei minha conta no passado, mas nunca usei
                </Typography>
              </AccordionSummary>
              <AccordionDetails className={classes.accordionDetails}>
                <Typography className={classes.resposta}>
                  R: Se esse for o seu caso, você precisará realizar uma
                  transferência de qualquer valor para sua conta. Se você não
                  tiver nenhum saldo para transferir, basta pedir para inserir o
                  CPF nas compras para gerar créditos.
                </Typography>
              </AccordionDetails>
            </Accordion>
            ...
            <Accordion className={classes.faqEntry}>
              ...
              >
                <Typography className={classes.pergunta}>
                  5. Preciso gastar muito para gerar mais créditos?
                </Typography>
              </AccordionSummary>
              <AccordionDetails className={classes.accordionDetails}>
                <Typography className={classes.resposta}>
                  R: Não, qualquer nota fiscal doada pode gerar até R$ 265,30 em
                  créditos para a AGENTE! Isso significa que um cafezinho na
                  padaria de R$ 5,00 pode se transformar numa doação de R$
                  265,30 para a AGENTE. Assim, o importante é sempre pedir o CPF
                  na nota independente do valor da compra
                </Typography>
              </AccordionDetails>
            </Accordion>
            ...
            <Accordion className={classes.faqEntry}>
              ...
              >
                <Typography className={classes.pergunta}>
                  6. Como é calculado o valor da doação?
                </Typography>
              </AccordionSummary>
              <AccordionDetails className={classes.accordionDetails}>
                <Typography className={classes.resposta}>
                  R: O valor da doação está relacionado ao imposto de ICMS pago
                  pelo estabelecimento no mês que você efetuou a sua compra.
                  Você pode conferir as regras de cálculo no site da receita da
                  fazenda. Clique aqui.
                </Typography>
              </AccordionDetails>
            </Accordion>
            ...
            <Accordion className={classes.faqEntry}>
              ...
              >
                <Typography className={classes.pergunta}>
                  7. A receita federal utilizará as notas fiscais doadas para me
                  monitorar?
                </Typography>
              </AccordionSummary>
              <AccordionDetails className={classes.accordionDetails}>
                <Typography className={classes.resposta}>
                  R: Não. A receita federal possui seu próprio banco de dados
                  para fiscalização e não precisa das informações do programa da
            ...
            <Accordion className={classes.faqEntry}>
              ...
              >
                <Typography className={classes.pergunta}>
                  8. Como o dinheiro doado é utilizado pela AGENTE?
                </Typography>
              </AccordionSummary>
              <AccordionDetails className={classes.accordionDetails}>
                <Typography className={classes.resposta}>
                  R: Todo dinheiro arrecado é utilizado para desenvolver os
                  projetos da AGENTE. Cerca de 80% dos recursos vão para a
                  equipe (educadores, cozinha, limpeza, administrativo e
                  coordenadores) e os 20% restantes são despesas gerais (ex.
                  materiais pedagógicos, alimentação, produtos de limpeza,
                  escritório de contabilidade, contas de água e luz etc)
                </Typography>
                <Typography className={classes.resposta}>
                  Desde 2012, a AGENTE apresenta as demonstrações financeiras
                  com os resultados do ano. Você pode conferi-las no nosso site
                </Typography>
              </AccordionDetails>
            </Accordion>
            ...
            <Accordion className={classes.faqEntry}>
              ...
              >
                <Typography className={classes.pergunta}>
                  9. Ainda ficou alguma dúvida?
                </Typography>
              </AccordionSummary>
              <AccordionDetails className={classes.accordionDetails}>
                <Typography className={classes.resposta}>
                  Escreva para{" "}
                  <a href="mailto:comunicacao@agente.org.br">
        ...
        <Box
          className={clsx(
            classes.conteudo,
            classes.invertido,
            isMobile && classes.fullHeight
          )}
        >
          <Separator invertido={true} />
          <Typography className={clsx(classes.titulo, classes.invertido)}>
            Quero saber mais!
          </Typography>
